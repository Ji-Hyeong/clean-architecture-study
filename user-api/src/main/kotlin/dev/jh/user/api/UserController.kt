package dev.jh.user.api

import dev.jh.shared.ApiResponse
import dev.jh.user.application.port.`in`.UpdateUserProfileCommand
import dev.jh.user.application.port.`in`.UserDeactivationCommand
import dev.jh.user.application.port.`in`.UserDeactivationUseCase
import dev.jh.user.application.port.`in`.UserProfileUseCase
import dev.jh.user.application.port.`in`.UserProvisioningCommand
import dev.jh.user.application.port.`in`.UserProvisioningUseCase
 ...
 */
private fun dev.jh.user.application.port.`in`.UserResult.toResponse(): UserResponse {
	return UserResponse(
		id = id,
		email = email,
		nickname = nickname,
